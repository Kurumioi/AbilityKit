...
export const adminNavigationItems: AdminNavigationItem[] = [
  ...
  { key: 'session', label: '会话', path: '/session', group: 'runtime', description: '账号与 Session 管理' },
  ...
  { key: 'skills', label: '技能分析', path: '/skills', group: 'diagnostics', description: 'MOBA Loadout 与技能诊断', requiresSession: true },
  { key: 'cluster', label: '集群诊断', path: '/cluster', group: 'diagnostics', description: 'Orleans/Gateway 集群状态' },
  { key: 'ops', label: '运维', path: '/ops', group: 'operations', description: '维护、Drain、重启请求', danger: true },
  { key: 'debug', label: '响应', path: '/debug', group: 'diagnostics', description: '最近接口响应 JSON' }
];
