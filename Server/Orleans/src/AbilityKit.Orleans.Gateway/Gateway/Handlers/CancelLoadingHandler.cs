...
/// </summary>
[Core.GatewayHandler(RoomGatewayOpCodes.CancelLoading)]
public sealed partial class CancelLoadingHandler : GatewayRequestHandlerBase
{
    private readonly IClusterClient _clusterClient;

    public CancelLoadingHandler(IClusterClient clusterClient)
    {
        ...
        CancellationToken cancellationToken)
    {
        ...
        var req = WireRoomGatewayBinary.Deserialize<WireCancelLoadingReq>(request.Payload);
        ...
        try
        {
            ...
            var grainReq = RoomGatewayWireMapper.ToCancelLoadingReq(accountId, req);
            var result = await room.CancelLoadingWithResultAsync(grainReq);
