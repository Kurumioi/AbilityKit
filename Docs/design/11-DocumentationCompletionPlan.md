...
| 目标文档 | `08-GameplayModules/04-ProjectileSystem.md` 到 `07-TargetingSystem.md`，EntityManager/SkillLibrary/Motion 专题 |
| 当前状态 | canonical Targeting、Projectile、Attribute 与 Damage 文档已建立；实体索引、技能库和移动仍按复用风险补专题 |
