...
{
    /// <summary>
    /// Legacy positional action module base. New trigger actions should inherit
    /// NamedArgsPlanActionModuleBase<TActionArgs, TCtx, TModule> and provide an IActionSchema.
    /// </summary>
    [Obsolete("Use NamedArgsPlanActionModuleBase<TActionArgs, TCtx, TModule> with IActionSchema for strongly typed plan actions. This legacy positional action path will be removed.")]
    ...
    /// <summary>
    /// Legacy simplified positional action module base. New trigger actions should inherit
    /// NamedArgsPlanActionModuleBase<TActionArgs, TCtx, TModule> and provide an IActionSchema.
    /// </summary>
    [Obsolete("Use NamedArgsPlanActionModuleBase<TActionArgs, TCtx, TModule> with IActionSchema for strongly typed plan actions. This legacy positional action path will be removed.")]
