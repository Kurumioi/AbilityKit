...
namespace AbilityKit.Demo.Moba.Services.Triggering.PlanActions
{
    ...
    public static class PlanContextValueResolver
    {
        ...
        {
            casterActorId = 0;
            if (args is IMobaActorContextProvider actorContext && actorContext.TryGetSourceActorId(out casterActorId) && casterActorId > 0) return true;
        ...
        {
            targetActorId = 0;
            if (args is IMobaActorContextProvider actorContext && actorContext.TryGetTargetActorId(out targetActorId) && targetActorId > 0) return true;
