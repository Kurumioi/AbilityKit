...
namespace AbilityKit.Demo.Moba.Services
{
    ...
    {
        public MobaGamePhaseService Phase { get; }
        ...
        /// 创建输入命令处理上下文。
        /// </summary>
        public MobaInputCommandContext(MobaGamePhaseService phase, MobaPlayerActorMapService playerActorMap, MobaEntityManager entities, SkillExecutor skills, IWorldResolver services)
        {
            Phase = phase;
