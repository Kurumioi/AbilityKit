...
namespace AbilityKit.Demo.Shooter.View.PlayMode
{
    ...
    public static class ShooterPlayModeSessionHost
    {
        ...
        public static ShooterAcceptanceSession Start(ShooterPlayModeSessionOptions options)
        {
            ...
            ShooterPlayModeSessionRegistry.NotifyHostsChanged();
            return session;
        }
        ...
        private static void RegisterPublishedHost()
        {
            ...
            ShooterPlayModeSessionRegistry.Register(Published);
            _registered = true;
        }
        ...
        private static void UnregisterPublishedHost()
        {
            ...
            ShooterPlayModeSessionRegistry.Unregister(Published);
            _registered = false;
        }
        ...
        private sealed class PublishedHost : IShooterPlayModeSessionHost
        {
