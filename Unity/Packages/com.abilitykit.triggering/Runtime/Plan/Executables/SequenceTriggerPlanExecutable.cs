...
{
    public sealed class SequenceTriggerPlanExecutable : CompositeTriggerPlanExecutableBase
    {
        public override string Name => "Sequence";
        public override ETriggerPlanExecutableKind Kind => ETriggerPlanExecutableKind.Sequence;

        public SequenceTriggerPlanExecutable(ITriggerPlanExecutable[] children, ITriggerPlanCondition condition = null, float weight = 1f)
