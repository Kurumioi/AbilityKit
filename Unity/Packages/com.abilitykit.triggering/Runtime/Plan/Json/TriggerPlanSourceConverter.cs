...
namespace AbilityKit.Triggering.Runtime.Plan.Json
{
    ...
    public sealed class TriggerPlanSourceConverter
    {
        ...
        public string ConvertSourceToRuntimeJson(string sourceJson)
        {
            ...
            var source = JsonConvert.DeserializeObject<TriggerPlanSourceJson>(sourceJson);
        ...
        private void WriteTrigger(JsonTextWriter writer, TriggerSourceTriggerJson trigger)
        {
            writer.WriteStartObject();
        ...
        private void WriteAction(JsonTextWriter writer, JObject action)
        {
            ...
            foreach (var prop in action.Properties())
            {
                ...
                WriteParamValue(writer, prop.Value);
            }
