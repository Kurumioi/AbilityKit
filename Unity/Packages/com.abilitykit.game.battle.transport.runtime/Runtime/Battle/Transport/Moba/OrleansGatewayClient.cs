...
{
    /// <summary>
    /// Orleans Gateway TCP 客户端
    /// 实现 Gateway 协议，与 Server/Orleans Gateway 通信
    /// </summary>
    public sealed class OrleansGatewayClient : IDisposable
    {
        ...
        {
            if (_disposed) throw new ObjectDisposedException(nameof(OrleansGatewayClient));
